# nИмпортируем библиотеку requests для получения данных страницы, на которой размещен json файл. Распаковываем его с помощью json. В полученном словаре в "results" в "powerstats" есть параметр "intelligence", в котором и хранится нужная информация:
import requests
import json
